...
def grid_lines(string):
    ...
    <path d="M20 0 L20 40" stroke-dasharray="4,4" stroke-width="0.7" stroke="#666" fill-opacity="0"/><path d="M0 0 l40 0 l0 40 l-40 0 z" stroke-width="1" stroke="#111" fill-opacity="0"/><g transform="translate(5,30) scale(0.029, -0.0286)">'''
